...
namespace RentalSystem.AdminForm
{
    public partial class AdminTransferForm : Form
    {
        ...
        public AdminTransferForm(AdminEntity admin)
        {
            InitializeComponent();
            this.admin = admin;
            get();
        ...
        public void get()
        {
            r = transferMapper.selectByTable(-2, -3, admin.A_id);
            if (r.IsOK)
            {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
                ...
                MessageBox.Show("确定要删除该记录？", "警告", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                ...
                r = transferMapper.updateState(t_id, 0, id, admin.A_id);
                if (r.IsOK)
                {
        ...
        private void dataGridView2_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
                ...
                MessageBox.Show("确定要删除该记录？", "警告", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                ...
                r = transferMapper.updateState(t_id, 0, admin.A_id, id);
                if (r.IsOK)
                {
